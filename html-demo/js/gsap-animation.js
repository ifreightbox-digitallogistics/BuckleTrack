...
function pbmit_staticbox_hover() {
	var pbmit_var = jQuery('.pbmit-element-static-box-style-1, .pbmit-element-static-box-style-2, .pbmit-element-award-box-style-1,.pbmit-element-service-style-1');
	if (!pbmit_var.length) {
		return;
	}
	pbmit_var.each(function() {
		var pbmit_Class = '.pbmit-element-posts-wrapper > .pbmit-ele-static-box,.pbmit-award-box-wraper, .pbmit-service-style-1';
		jQuery(this)
...
function pbmit_sticky_menu() {
	if (!$(".pbmit-element-portfolio-style-2,.pbmit-element-split-slide-style-1")[0]) {
		return
	}
	ScrollTrigger.matchMedia({
		"(min-width: 992px)": function() {

			let container = $(".pbmit-element-portfolio-style-2 .pbmit-img, .pbmit-element-split-slide-style-1 .pbmit-img");
			let section = $(".pbmit-element-portfolio-style-2 .pbmit-element-posts-wrapper, .pbmit-element-split-slide-style-1 .pbmit-element-split-slide-wrapper");
			var indicators = gsap.utils.toArray('.pbmit-element-portfolio-style-2 .pbmit-split-slide-item-image, .pbmit-element-split-slide-style-1 .pbmit-split-slide-item-image');
			var points = gsap.utils.toArray('.pbmit-element-portfolio-style-2 .pbmit-bg-imgbox .pbminfotech-portfolio-des, .pbmit-element-split-slide-style-1 .pbmit-bg-imgbox .pbmit-split-slide-box');
			...
			$('.pbmit-element-portfolio-style-2 .pbmit-bg-imgbox .pin-spacer .pbmit-split-slide-item-image:first-child,.pbmit-element-split-slide-style-1 .pbmit-bg-imgbox .pin-spacer .pbmit-split-slide-item-image:first-child').addClass('active');
		},
